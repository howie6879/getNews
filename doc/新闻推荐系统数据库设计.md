...
| 后台管理员表     | 编号，用户名，密码                                |
| 新闻热点       | 新闻编号，时间，标签，喜欢次数，评论次数，阅读次数                |
...
```mysql
create view news_hot as select a.news_id,a.time,b.tag,b.love_times,b.read_times,b.comment_times from get_news a join news_mess b where a.news_id = b.news_id;
```
