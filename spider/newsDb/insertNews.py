...
class newsInsert:
    ...
    def insertSql(self, mainPath):
        path = dirPath + "/spider/wordAna/" + mainPath
        ...
        try:
            ...
            for i in range(0, len(data)):
                ...
                if value[11]:
                    ...
                    try:
                        mysqlSuccess = db.insert_table(table="get_news",
                                                       field="(news_id,news_link,source,title,abstract,tag,"
                                                             "text_content,html_content,image,keyword)",
                                                       values="('" + newsId + "','" + value[2] + "','" + value[
                                                           4] + "','" +
                                                              value[1]
                                                              + "','" + value[6] + "','" + tag + "','" + value[
                                                                  10] + "','" + value[11] + "','" + value[12] + "','" +
                                                              value[
                                                                  9] + "')")
